...
HeapObject _refreshStaticSelection(
  final HeapObject selection,
  final InstanceRef? liveObject,
) {
    ...
    case RefNodeType.staticInRefs:
      final children =
          ref.heapSelection
              ...
              .where((final s) => !s.className!.isNull)
              .map(
                (final s) => DartObjectNode.references(
...
void _addLiveReferenceToNode(
  final List<DartObjectNode> variables,
