...
export class FlutterRpcHandlers {
  ...
  async handleGetWidgetTree(port: number, params?: any): Promise<unknown> {
    ...
    const result = await this.server.invokeFlutterExtension(
      port,
      "debug.dumpRenderTree",
      {}
    );
  ...
  async handleGetExtensionRpcs(port: number, params?: any): Promise<unknown> {
    const result = await this.server.invokeFlutterExtension(
      port,
      "get_extension_rpcs",
      { isolateId: params?.isolateId, isRawResponse: params?.isRawResponse }
    );
    return this.server.wrapResponse(Promise.resolve(result));
  }
   ...
   */
  async handleDebugDumpSemanticsTree(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
    const result = await this.server.invokeFlutterExtension(
      port,
      "debug.dumpSemanticsTreeInTraversalOrder",
      {}
    );
    return this.server.wrapResponse(Promise.resolve(result));
  }
   ...
   */
  async handleDebugDumpSemanticsTreeInverse(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
    const result = await this.server.invokeFlutterExtension(
      port,
      "debug.dumpSemanticsTreeInInverseHitTestOrder",
      {}
    );
    return this.server.wrapResponse(Promise.resolve(result));
  }
   ...
   */
  async handleDebugPaintBaselinesEnabled(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
   ...
   */
  async handleDebugDisablePhysicalShapeLayers(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
   ...
   */
  async handleDebugDisableOpacityLayers(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
   ...
   */
  async handleInspectorScreenshot(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
   ...
   */
  async handleInspectorGetLayoutExplorerNode(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
    const result = await this.server.invokeFlutterExtension(
      port,
      "inspector.getLayoutExplorerNode",
   ...
   */
  async handleInspectorTrackRebuildDirtyWidgets(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
   ...
   */
  async handleInspectorSetSelectionById(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
   ...
   */
  async handleInspectorGetParentChain(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
   ...
   */
  async handleInspectorGetChildrenSummaryTree(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
    const result = await this.server.invokeFlutterExtension(
      port,
      "inspector.getChildrenSummaryTree",
      { objectId: params?.objectId }
    );
    return this.server.wrapResponse(Promise.resolve(result));
  }
   ...
   */
  async handleInspectorGetDetailsSubtree(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
   ...
   */
  async handleInspectorGetSelectedWidget(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
   ...
   */
  async handleInspectorGetSelectedSummaryWidget(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
    const result = await this.server.invokeFlutterExtension(
      port,
      "inspector.getSelectedSummaryWidget",
      {}
    );
    return this.server.wrapResponse(Promise.resolve(result));
  }
   ...
   */
  async handleInspectorIsWidgetCreationTracked(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
    const result = await this.server.invokeFlutterExtension(
      port,
      "inspector.isWidgetCreationTracked",
      {}
    );
    return this.server.wrapResponse(Promise.resolve(result));
  }
   ...
   */
  async handleDartIoSocketProfilingEnabled(
    port: number,
    params?: any
  ): Promise<unknown> {
    const result = await this.server.invokeFlutterExtension(
      port,
      "dart.io.socketProfilingEnabled",
      { enabled: params?.enabled }
    );
    return this.server.wrapResponse(Promise.resolve(result));
  }
   ...
   */
  async handleDartIoHttpEnableTimelineLogging(
    port: number,
    params?: any
  ): Promise<unknown> {
    const result = await this.server.invokeFlutterExtension(
      port,
      "dart.io.httpEnableTimelineLogging",
      { enabled: params?.enabled }
    );
    return this.server.wrapResponse(Promise.resolve(result));
  }
   ...
   */
  async handleInspectorStructuredErrors(
    port: number,
    params?: any
  ): Promise<unknown> {
    await this.server.verifyFlutterDebugMode(port);
